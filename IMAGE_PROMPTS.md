...
*Color reference: `src/index.css` — `:root` variables + Tailwind `@theme` neutral scale*  
*Section bg mapping: About/Experience/Education = `#ffffff` · Skills/Projects/Contact = `#f8fafc`*
