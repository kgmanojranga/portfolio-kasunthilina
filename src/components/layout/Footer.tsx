    ...
    <footer className="bg-neutral-100 border-t border-neutral-200">
      ...
      <div className="container-custom py-14 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col gap-4">
          <a href="#hero" className="text-2xl font-bold text-neutral-900 tracking-tight">KT</a>
          <p className="text-sm text-neutral-500 leading-relaxed max-w-xs">
            {title} based in Sri Lanka. Building reliable, well-tested backend systems.
          </p>
          <a
        ...
        {/* Navigation */}
        <div className="flex flex-col gap-4">
          <p className="text-xs font-medium text-neutral-400 tracking-widest uppercase">Navigation</p>
        ...
        {/* Contact */}
        <div className="flex flex-col gap-4">
          <p className="text-xs font-medium text-neutral-400 tracking-widest uppercase">Contact</p>
          <div className="flex flex-col gap-3">
            ...
            <p className="text-sm text-neutral-400 leading-relaxed">{contact.address}</p>
          </div>
        </div>
